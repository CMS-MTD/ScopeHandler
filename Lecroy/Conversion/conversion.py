...
# trigger_times3,horizontal_offsets3 = get_segment_times(inputFiles[2],offset,nsegments)#20GS/s
# trigger_times3,horizontal_offsets4 = get_segment_times(inputFiles[3],offset,nsegments)#20GS/s
...
for i in range(nsegments):
    ...
    # channel[3] = get_vertical_array(inputFiles[3],full_offset,points_per_frame,vertical_gains[3],vertical_offsets[3],i)#20GS/s
    ...
    # time_offsets[2] = horizontal_offsets3[i]-horizontal_offsets[i]#20GS/s
    # time_offsets[3] = horizontal_offsets4[i]-horizontal_offsets[i]#20GS/s
